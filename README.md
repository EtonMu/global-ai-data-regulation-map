...
The Research Lab defaults to the **39 version-locked complete corpora** and to provisions reviewed as **substantive** for the project's subject matter. Controls can reveal selected-source instruments and structural provisions, but incomplete coverage is never silently mixed into the default comparative sample.
